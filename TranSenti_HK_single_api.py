...
def keyword_prefilter(directory, output_directory):
    ...
    keywords = [
        ...
        # HK station name list (long list of station names kept intact)
...
def datafilter(directory, output_directory, batch_size=50):
    ...
    client = OpenAI(api_key="sk-7c87ef2add054e439095db9b18c921e9", base_url="https://api.deepseek.com")
        ...
        for i in range(0, len(valid_df), batch_size):
            ...
            response = client.chat.completions.create(
                ...
                messages=[
                    ...
                    {"role": "user", "content": f"""请评估以下{len(batch_df)}个社交媒体post是否是对地铁公交服务质量、地铁公交环境相关的评价。
